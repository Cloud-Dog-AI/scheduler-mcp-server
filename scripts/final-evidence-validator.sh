...
check "design pack (1400-1404) present" bash -c "test -s ${EVIDENCE_ROOT}/W28K-1400-thread-def-confirmation.md && test -s ${EVIDENCE_ROOT}/W28K-1401-gap-analysis.md && test -s ${EVIDENCE_ROOT}/W28K-1402-requirements-catalogue.md && test -s ${EVIDENCE_ROOT}/W28K-1403-design.md && test -s ${EVIDENCE_ROOT}/W28K-1404-test-strategy.md"
